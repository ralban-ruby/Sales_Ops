view: onboarding {
    ...
    dimension_group: week_1_usage_date {
      ...
      datatype: datetime
      sql: DATEADD(DAY,7,${active_status_date_adjusted_date}) ;;
    }

    dimension_group: active_status_date_adjusted {
      label: "Adjusted Active Status Date"
      type: time
      timeframes: [
        raw,
        date,
      ...
      datatype: datetime
      sql: DATEADD(HOUR,-8,${Active_Status__c_date}) ;;
    }
